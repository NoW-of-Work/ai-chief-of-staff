...
- May not write personal or sensitive detail about an attendee, in any file, without approval in the same session. This is `CLAUDE.md` gate 6. In prep specifically, the answer should almost always be no. Work facts are enough.
