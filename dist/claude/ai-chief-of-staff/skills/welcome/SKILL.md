...
- The first thing the leader says after installing, whatever they say. If `CLAUDE.md` and the workspace files are all missing, this is a fresh install and nothing else should run first.
