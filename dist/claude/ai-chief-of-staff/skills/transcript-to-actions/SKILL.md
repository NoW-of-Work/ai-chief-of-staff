...
description: "Turn one meeting transcript or set of notes into decisions, action items, commitments for the ledger, and person-file updates. Structured, no essay. Use after a recorded meeting."
---
...
Facts about work only. Never anything personal, medical, financial, or about their family, even when the transcript contains it. That is approval gate 6 in `CLAUDE.md`, and in this behaviour the answer is no. A transcript is exactly where that kind of detail leaks in.
