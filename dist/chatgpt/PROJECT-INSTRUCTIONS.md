# PROJECT-INSTRUCTIONS.md — AI Chief of Staff Operating Manual
...
1. This file (`PROJECT-INSTRUCTIONS.md`).
...
Behaviours are the numbered prompt files in `prompts/`. Paste the one you want at the start of a chat, or keep them in the project so you can call them by name.
...
*AI Chief of Staff v1.3.0. Created by The NoW of Work. MIT licensed. Yours to edit.*
