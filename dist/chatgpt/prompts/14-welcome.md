> **welcome**. Introduce the system to a leader who has just installed it: what it does, what it needs, what it will never do, and a handoff into setup. Use on a first run or when asked what this is.
>
...
> "run welcome" and point at the file. The project instructions
...
- The first thing the leader says after installing, whatever they say. If `PROJECT-INSTRUCTIONS.md` and the workspace files are all missing, this is a fresh install and nothing else should run first.
