> **connection-check**. Diff live connectors against connections.md. Update the registry, queue activation offers, flag anything silently broken, and decide (rarely) if a missing tool is worth one line. Weekly.
>
...
> "run connection-check" and point at the file. The project instructions
