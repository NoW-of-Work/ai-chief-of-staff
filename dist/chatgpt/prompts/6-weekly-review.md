> **weekly-review**. Monday look back and forward: what moved, what slipped, where the time went, drift against what you said you are not doing, next week's focus, workspace maintenance, and decisions due. 500 words.
>
...
> "run weekly-review" and point at the file. The project instructions
...
- May **not** change priorities in `my-work.md` without approval, per `PROJECT-INSTRUCTIONS.md` gate 7. Propose, then wait.
