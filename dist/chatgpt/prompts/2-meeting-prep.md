> **meeting-prep**. Prep for a specific meeting: who, why, what happened last time, what is open between you both ways, three questions worth asking, and the risks. 300 words. Use before a meeting that matters.
>
...
> "run meeting-prep" and point at the file. The project instructions
...
- May not write personal or sensitive detail about an attendee, in any file, without approval in the same session. This is `PROJECT-INSTRUCTIONS.md` gate 6. In prep specifically, the answer should almost always be no. Work facts are enough.
