...
**It reads. It does not close.** Promoting an entry to `Made` needs you saying what you decided, in your own words, in that session. That is gate 11 in `{{MANUAL}}`, and a scheduled run has nobody in the room.
