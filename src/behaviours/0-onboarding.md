...
| Path | If missing |
|------|-----------|
| `{{MANUAL}}` | {{#claude}}Copy from `templates/CLAUDE.md` in this skill folder{{/claude}}{{#chatgpt}}Write it out from the copy in the project files{{/chatgpt}} |
| `about-me.md` | {{#claude}}Copy from `templates/about-me.md`{{/claude}}{{#chatgpt}}Write out the blank template{{/chatgpt}} |
